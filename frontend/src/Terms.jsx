      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full animate-in fade-in slide-in-from-bottom-5 duration-700">
        ...
        <div className="space-y-12 text-lg text-gray-700 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p className="pl-11">
              By using our platform, you agree to follow these terms and conditions.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-16 space-y-2 marker:text-indigo-500">
              <li>Users must provide correct details</li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-16 space-y-2 marker:text-indigo-500">
              <li>Respect venue rules</li>
              <li>Use the platform properly</li>
              <li>No misuse of services</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-16 space-y-2 marker:text-indigo-500">
              <li>Refunds depend on cancellation time</li>
              <li>Terms may vary by booking</li>
            </ul>
          </section>
          ...
          <section className="space-y-4 pt-6 border-t border-gray-100">
            ...
            <p className="pl-11">
              For any queries, contact us at <a href="mailto:support@sportshub.com" className="text-blue-600 font-semibold hover:underline decoration-2 underline-offset-4">support@sportshub.com</a>
            </p>
          </section>
